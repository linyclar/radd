...
require "spec_helper"
require "generators/rspec/radd/view/rule/rule_generator"

RSpec.describe Rspec::Radd::View::Generators::RuleGenerator, type: :generator do
  ...
  describe "#copy_rule" do
    ...
    context "bin/rails g radd:rule calc" do
      it_behaves_like("ファイルが生成される", "calc", "spec/view/rule/calc_view_rule.rb")
    end

    context "bin/rails g radd:rule accounting_feature/calc" do
      it_behaves_like("ファイルが生成される", "accounting_feature/calc",
                      "spec/view/rule/accounting_feature/calc_view_rule.rb")
    end
  end
end
