...
require "spec_helper"
require "generators/rspec/radd/value_object/value_object_generator"

RSpec.describe Rspec::Radd::Generators::ValueObjectGenerator, type: :generator do
  ...
  describe "#copy_value_object" do
    ...
    context "bin/rails g radd:value_object title" do
      it_behaves_like("ファイルが生成される", "title", "spec/value_object/title_value_object.rb")
    end

    context "bin/rails g radd:value_object accounting_feature/title" do
      it_behaves_like("ファイルが生成される", "accounting_feature/title",
                      "spec/value_object/accounting_feature/title_value_object.rb")
    end
  end
end
